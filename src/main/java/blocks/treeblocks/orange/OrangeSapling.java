...
public class OrangeSapling extends BlockSapling
{
	...
	public OrangeSapling(int par1)
	{
		...
		this.setUnlocalizedName("orangewoodsapling");
			...
			Random par5Random)
	{
		...
		(new WorldGenOrangeTree()).generate(par1World, par5Random, par2,
				par3, par4);
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		this.blockIcon = par1IconRegister
				.registerIcon("awmf:orangesapling");
	}
}

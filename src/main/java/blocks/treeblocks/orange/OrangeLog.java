package multifood.blocks.treeblocks.orange;
...
public class OrangeLog extends BlockRotatedPillar
{
	@SideOnly(Side.CLIENT)
	private Icon orangeLogTopIcon;
	@SideOnly(Side.CLIENT)
	private Icon orangeLogBottomIcon;
	
	public OrangeLog(int par1)
	{
	...
	{
		this.orangeLogTopIcon = par1IconRegister
				.registerIcon("awmf:orangelog_top");
		this.orangeLogBottomIcon = par1IconRegister
				.registerIcon("awmf:orangelog_top");
		this.blockIcon = par1IconRegister.registerIcon("awmf:orangelog_side");
	}

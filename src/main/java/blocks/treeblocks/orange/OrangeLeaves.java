...
public class OrangeLeaves extends BlockLeaves implements IShearable
{
			...
			int par4, int par5, float par6, int par7)
	{
		if (!par1World.isRemote)
		{
			...
			{
				int k1 = Blocks.orangeSapling.blockID;
			...
			{
				this.dropBlockAsItem_do(par1World, par2, par3, par4,
						new ItemStack(Items.orange, 1, 0));
			}
		}
	}
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("awmf:orangeleaves");
	}

...
public class LemonLog extends BlockRotatedPillar
{
	@SideOnly(Side.CLIENT)
	private Icon lemonLogTopIcon;
	@SideOnly(Side.CLIENT)
	private Icon lemonLogBottomIcon;
	
	public LemonLog(int par1)
	{
	...
	{
		this.lemonLogTopIcon = par1IconRegister
				.registerIcon("awmf:lemonlog_top");
		this.lemonLogBottomIcon = par1IconRegister
				.registerIcon("awmf:lemonlog_top");
		this.blockIcon = par1IconRegister.registerIcon("awmf:lemonlog_side");
	}

...
public class LimeSapling extends BlockSapling
{
	
	public static final String[] WOOD_TYPES = new String[] { "lime" };
	@SideOnly(Side.CLIENT)
	private Icon[] saplingIcon;
	
	public LimeSapling(int par1)
	{
		super(par1);
		float f = 0.4F;
		...
		this.setUnlocalizedName("limewoodsapling");
			...
			Random par5Random)
	{
		...
		(new WorldGenLimeTree()).generate(par1World, par5Random, par2,
				par3, par4);
	}

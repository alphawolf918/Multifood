...
public class LimeLog extends BlockRotatedPillar
{
	@SideOnly(Side.CLIENT)
	private Icon limeLogTopIcon;
	@SideOnly(Side.CLIENT)
	private Icon limeLogBottomIcon;
	
	public LimeLog(int par1)
	{
		super(par1, Material.wood);
		this.setCreativeTab(ModTabs.mfTab);
		this.setUnlocalizedName("limelog");
	...
	{
		this.limeLogTopIcon = par1IconRegister
				.registerIcon("awmf:limelog_top");
		this.limeLogBottomIcon = par1IconRegister
				.registerIcon("awmf:limelog_top");
		this.blockIcon = par1IconRegister.registerIcon("awmf:limelog_side");
	}

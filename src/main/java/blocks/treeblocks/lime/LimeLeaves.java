package multifood.blocks.treeblocks.lime;
...
public class LimeLeaves extends BlockLeaves implements IShearable
{
	public static final String[] LEAF_TYPES = new String[] { "lime" };
	...
	public LimeLeaves(int par1)
	{
		super(par1);
		this.setTickRandomly(true);
		this.setCreativeTab(ModTabs.mfTab);
		this.setUnlocalizedName("limeleaves");
			...
			int par4, int par5, float par6, int par7)
	{
		if (!par1World.isRemote)
		{
			...
			{
				int k1 = Blocks.limeSapling.blockID;
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("awmf:limeleaves");
	}

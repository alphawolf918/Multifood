...
import multifood.worldgen.WorldGenLimonTree;
...
public class LimonSapling extends BlockSapling
{
	
	public static final String[] WOOD_TYPES = new String[] { "limon" };
	@SideOnly(Side.CLIENT)
	private Icon[] saplingIcon;
	
	public LimonSapling(int par1)
	{
		super(par1);
		float f = 0.4F;
		...
		this.setUnlocalizedName("limonwoodsapling");
			...
			Random par5Random)
	{
		...
		(new WorldGenLimonTree()).generate(par1World, par5Random, par2,
				par3, par4);
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		this.blockIcon = par1IconRegister
				.registerIcon("awmf:limonsapling");
	}
}

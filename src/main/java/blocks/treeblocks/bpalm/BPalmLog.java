...
public class BPalmLog extends BlockRotatedPillar
{
	...
	public BPalmLog(int par1)
	{
		super(par1, Material.wood);
		this.setCreativeTab(ModTabs.mfTab);
		this.setUnlocalizedName("bpalmlog");
	...
	{
		this.palmLogTopIcon = par1IconRegister
				.registerIcon("awmf:bpalmlog_top");
		this.palmLogBottomIcon = par1IconRegister
				.registerIcon("awmf:bpalmlog_top");
		this.blockIcon = par1IconRegister.registerIcon("awmf:bpalmlog_side");
	}

...
public class CherrySapling extends BlockSapling
{
	...
	public CherrySapling(int par1)
	{
		...
		this.setUnlocalizedName("cherrywoodsapling");
			...
			Random par5Random)
	{
		...
		(new WorldGenCherryTree()).generate(par1World, par5Random, par2,
				par3, par4);
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		this.blockIcon = par1IconRegister
				.registerIcon("awmf:cherrysapling");
	}
}

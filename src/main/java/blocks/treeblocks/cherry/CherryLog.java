...
public class CherryLog extends BlockRotatedPillar
{
	...
	private Icon cherryLogTopIcon;
	@SideOnly(Side.CLIENT)
	private Icon cherryLogBottomIcon;
	
	public CherryLog(int par1)
	{
	...
	{
		this.cherryLogTopIcon = par1IconRegister
				.registerIcon("awmf:cherrylog_top");
		this.cherryLogBottomIcon = par1IconRegister
				.registerIcon("awmf:cherrylog_top");
		this.blockIcon = par1IconRegister.registerIcon("awmf:cherrylog_side");
	}

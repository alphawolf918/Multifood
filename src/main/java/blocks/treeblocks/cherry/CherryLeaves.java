package multifood.blocks.treeblocks.cherry;
...
public class CherryLeaves extends BlockLeaves implements IShearable
{
	...
	public CherryLeaves(int par1)
	{
		super(par1);
		this.setTickRandomly(true);
		this.setCreativeTab(ModTabs.mfTab);
		this.setUnlocalizedName("cherryleaves");
			...
			int par4, int par5, float par6, int par7)
	{
		if (!par1World.isRemote)
		{
			...
			{
				int k1 = Blocks.cherrySapling.blockID;
			...
			{
				this.dropBlockAsItem_do(par1World, par2, par3, par4,
						new ItemStack(Items.cherry, 2, 0));
			}
		}
	}
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("awmf:cherry_leaves");
	}

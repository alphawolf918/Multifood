...
public class GrapefruitLeaves extends BlockLeaves implements IShearable
{
	public static final String[] LEAF_TYPES = new String[] { "grapefruit" };
	...
	public GrapefruitLeaves(int par1)
	{
		super(par1);
		this.setTickRandomly(true);
		this.setCreativeTab(ModTabs.mfTab);
		this.setUnlocalizedName("grapefruitleaves");
			...
			int par4, int par5, float par6, int par7)
	{
		if (!par1World.isRemote)
		{
			...
			{
				int k1 = Blocks.gfruitSapling.blockID;
			...
			{
				this.dropBlockAsItem_do(par1World, par2, par3, par4,
						new ItemStack(Items.grapefruit, 1, 0));
			}
		}
	}
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("awmf:grapefruitleaves");
	}

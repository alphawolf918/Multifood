...
public class GrapefruitLog extends BlockRotatedPillar
{
	@SideOnly(Side.CLIENT)
	private Icon grapefruitLogTopIcon;
	@SideOnly(Side.CLIENT)
	private Icon grapefruitLogBottomIcon;
	
	public GrapefruitLog(int par1)
	{
		super(par1, Material.wood);
		this.setCreativeTab(ModTabs.mfTab);
		this.setUnlocalizedName("grapefruitlog");
	...
	{
		return this.grapefruitLogTopIcon;
	}
	...
	{
		this.grapefruitLogTopIcon = par1IconRegister
				.registerIcon("awmf:grapefruitlog_top");
		this.grapefruitLogBottomIcon = par1IconRegister
				.registerIcon("awmf:grapefruitlog_top");
		this.blockIcon = par1IconRegister
				.registerIcon("awmf:grapefruitlog_side");
	}

...
public class GrapefruitSapling extends BlockSapling
{
	
	public static final String[] WOOD_TYPES = new String[] { "grapefruit" };
	@SideOnly(Side.CLIENT)
	private Icon[] saplingIcon;
	
	public GrapefruitSapling(int par1)
	{
		super(par1);
		float f = 0.4F;
		...
		this.setUnlocalizedName("grapefruitwoodsapling");
			...
			Random par5Random)
	{
		...
		(new WorldGenGrapefruitTree()).generate(par1World, par5Random, par2,
				par3, par4);
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		this.blockIcon = par1IconRegister
				.registerIcon("awmf:grapefruitsapling");
	}
}